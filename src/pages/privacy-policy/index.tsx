const TermsOfServicePage = () => {
  return (
    <div className="p-5">
      <h1 className="text-3xl font-bold">隱私權保護政策</h1>
      <div className="p-5">
        非常歡迎您光臨Moltiai，為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
        <br></br>
        一、隱私權保護政策的適用範圍
        ...
        <br></br>• 於一般瀏覽時，伺服器會自行記錄相關行徑，包括您使用連線設備的
        IP
        ...
        前項但書之情形包括不限於： • 經由您書面同意。<br></br> • 法律明文規定。{" "}
        <br></br>• 為免除您生命、身體、自由或財產上之危險。<br></br>•
