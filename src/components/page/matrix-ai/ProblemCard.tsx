...
export default function ProblemCard({ title, image, index }: ProblemCardProps) {
  return (
    ...
    >
      <div className="absolute left-[-20px] bottom-16 shadow-md text-white flex justify-center items-center rounded-full w-[80px] h-[80px] bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400">
        {index + 1}
      </div>
